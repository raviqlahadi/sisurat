...
class Surat_keluar extends Admin_Controller {
    ...
    private $name = null;
    private $parent_page = 'surat_keluar';
    private $current_page = 'surat/surat_keluar';
    private $form_data = null;
    private $data_type = null;
    private $label = null;
    private $block_header = "Manajemen Surat Keluar";
    ...
    public function __construct(){
        ...
        $this->label = $this->label();
        $this->load->model(array('m_surat_keluar'));
    ...
    public function index(){
        ...
        $tabel_cell = ["kepada", "tanggal","keterangan", "document", "status_surat"];
       ...
       //fetch data from database
        $fetch['select'] = ["id", "kepada", "no", "tanggal", "perihal", "keterangan", "document", "status"];
        ...
        $fetch['like'] = ($key != null && $key != '') ? array("name" => array(
          'table_surat_keluar.perihal',
          'table_surat_keluar.nomor',
          'table_surat_keluar.tanggal'
        ), "key" => $key) : null;
        $fetch['order'] = array("field" => "table_surat_keluar.id", "type" => "ASC");
        $for_table = $this->m_surat_keluar->fetch($fetch);

        $pagination['total_records'] =  $this->m_surat_keluar->fetch($fetch, true);
        //set pagination
        //var_dump($pagination);
        ...
        $this->render( "surat/surat_keluar/content");
    }
    ...
    public function create(){
      ...
      $this->data["block_header"] = $this->block_header;
      $this->data["header"] = "Tambah surat_keluar";
      $this->data["sub_header"] = 'Tekan Tombol Simpan Ketika Selesai Mengisi Form';
      $this->render( "surat/surat_keluar/create");
    }

    public function insert($data) {
      $insert = $this->m_surat_keluar->add($data);
      return $insert;
    }
    ...
    public function edit($id=null){
      ...
      $w['id'] = $id;
      $form_value = $this->m_surat_keluar->getWhere($w);
      if($form_value==false){
        redirect($this->current_page);
      }else{
      ...
      $this->data['parent_page'] = $this->current_page;
      $this->data["block_header"] = $this->block_header;
      $this->data["header"] = "Ubah surat_keluar";
      $this->data["sub_header"] = 'Silahkan ubah data yang ingin anda ganti';
      $this->render( "surat/surat_keluar/edit");
    }

    public function update($id, $data) {
      $insert = $this->m_surat_keluar->update($id, $data);
      return $insert;
    }
    ...
    public function detail($id=null){
      ...
      $this->data["block_header"] = $this->block_header;
      $this->data["header"] = "Detail surat_keluar";
      $this->data["sub_header"] = 'Halaman Ini Hanya Berisi Informasi Detail Dari Data';
      $this->render("surat/surat_keluar/detail");
    }
    ...
    public function delete($id) {
      ...
      $w['id'] = $id;
      $delete = $this->m_surat_keluar->delete($w);
      if($delete!=false){
    ...
    private function attribute(){
      return [
        "id", "kepada", "no", "tanggal", "perihal", "keterangan", "document", "status"
      ];
    }
    ...
    private function data_type(){
      $name = $this->name;
      $type =   [
       "number", "text", "text", "date", "text", "textarea", "file", "select"
      ];
      $type_arr = array();
      foreach ($name as $key => $value) {
  ...
  private function getStatus()
  {
    ...
    $all_type =  $this->m_status->getWhere(array("type"=>"surat_keluar"));
